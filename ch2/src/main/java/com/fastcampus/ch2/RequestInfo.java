...
public class RequestInfo {
	...
	public void main(HttpServletRequest request) {
			...
			System.out.println("request.getCharacterEncoding"+request.getCharacterEncoding());//요청내용인코딩
			System.out.println("request.getContentLength()"+request.getContentLength());//요청내용길이.알수없으면 -1
